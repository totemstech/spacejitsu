 ...
 * @extends {}
 * 
 * @param spec {GL, latbands, lngbands, radius}
 */
var sphere = function(spec, my) {
  ...
  /**
   * Sets the color of the current sphere
  ...
  setColor = function(color) {
    ...
    my.sphereVertexColorBuffer.numItems = my.latbands * my.lngbands;
  };
